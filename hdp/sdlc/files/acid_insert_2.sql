...
FROM raw_2_dataset
INSERT INTO acid_2_dataset PARTITION (part='${PART}')
...
MERGE INTO merge_2_dataset PARTITION (part='${PART}') AS T USING
SELECT *
FROM raw_2_dataset
WHERE part='${PART}' AS S ON
