...
# Now Deploy
print('Deploy Docker Stack "INFRA" ')
subprocess.call(['docker','-H','os01:2375','stack','deploy','--compose-file','../hdp/setup/stack-compose/infra.yaml', 'INFRA'], stderr=subprocess.STDOUT)
